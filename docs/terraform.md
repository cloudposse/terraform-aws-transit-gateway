...
| <a name="input_amazon_side_asn"></a> [amazon\_side\_asn](#input\_amazon\_side\_asn) | Private Autonomous System Number (ASN) for the Amazon side of a BGP session. Valid values: 64512-65534 for 16-bit ASNs, 4200000000-4294967294 for 32-bit ASNs. Default value: `64512` | `number` | `64512` | no |
